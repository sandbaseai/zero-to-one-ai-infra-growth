...
Today's channels should support SandBase's positioning:

```text
Agent infrastructure for developers building production AI agents.
```

Avoid channels that force SandBase into a generic AI app category.

## Target 1 — Peerlist Project
...
- better fit for infrastructure than broad AI tool directories
- useful public trust asset if the profile can link website and GitHub
...
- can work if SandBase is positioned as infrastructure
- useful as a second profile after Peerlist
...
- less developer-specific than Peerlist or DevHunt
- should be used only if copy can stay infrastructure-focused
